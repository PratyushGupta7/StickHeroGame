...
public class EndController implements Initializable{
    ...
    void clickingReviveButton(ActionEvent event) throws IOException, ClassNotFoundException, URISyntaxException {
        ...
        if (numCherries >= 3) {
            WorldController.setNumCherries(numCherries - 3);
...
// Get the bounds of the myrectangle in the screen
    ...
    private void updateCharacter() throws IOException, ClassNotFoundException {
        ...
        if (characterBounds != null && ghostBounds != null) {
            if (characterBounds.getMaxX() > ghostBounds.getMinX() && characterBounds.getMaxY() > ghostBounds.getMinY() && characterBounds.getMinX() < ghostBounds.getMaxX() && characterBounds.getMinY() < ghostBounds.getMaxY()) {
                ...
                if (myGhost.getX() <= ghostDistance) { // Check if the ghost has reached the leftmost end of the canvas
                    myGhost.setVisible(false);
                    ((Pane) root).getChildren().remove(myGhost);
...
//        }
    ...
    void clickingHomeButton(ActionEvent event) throws IOException, ClassNotFoundException {
        ...
        ObjectOutputStream out = null;
        try {
            out = new ObjectOutputStream(Files.newOutputStream(Paths.get("C:\\Users\\dhruv\\Downloads\\FinalDeadline1\\AP_2022170_2022375\\AP_2022170_2022375\\stickhero\\src\\main\\java\\com\\example\\stickhero\\savedgame.txt")));
...
//        try {
//            in = new ObjectInputStream(new FileInputStream("C:\\Users\\dhruv\\Downloads\\FinalDeadline1\\AP_2022170_2022375\\AP_2022170_2022375\\stickhero\\src\\main\\java\\com\\example\\stickhero\\savedgame.txt"));
